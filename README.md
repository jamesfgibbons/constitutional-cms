...
## Claim Gate v0.1 (DRAFT, pre-ratification)
...
constitutional-cms claim-verify --bundle bundle.json --keys keys.json   # offline; exit 0 verified, 1 refused, 2 error
```
...
- [Entity lifecycle](contracts/entity_lifecycle.yaml) — Gone is a verdict; 410 needs terminal authority
