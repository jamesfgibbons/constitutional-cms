...
This file is **reference**, not the product page. Start at the [README](../README.md): clone, install, write a receipt.

The sections below are the long constitution that used to live under the README fold: five contracts, priority stack, cybernetics, and the repository map. Do not treat them as a prerequisite to running the fixture.
...
- [`INCIDENT_LEARNED_INVARIANTS.md`](INCIDENT_LEARNED_INVARIANTS.md) documents the sanitized invariant set
...
- [`V0_2_REFERENCE_PATTERNS.md`](V0_2_REFERENCE_PATTERNS.md) explains how implicit contracts become explicit ones
...
- [`CONSTITUTIONAL_CYBERNETICS.md`](CONSTITUTIONAL_CYBERNETICS.md) defines the sensors / state / controllers / actuators / dampers / proof model
...
work. Read [`PROTOCOL_MAP.md`](PROTOCOL_MAP.md) before applying any numbered scheme.
...
More detail lives in [`WEB_CONFORMANCE.md`](WEB_CONFORMANCE.md),
[`ADAPTER_BOUNDARY.md`](ADAPTER_BOUNDARY.md),
[`AGENT_COORDINATION.md`](AGENT_COORDINATION.md), and on
...
See [`PRIOR_ART.md`](PRIOR_ART.md) for the full comparison. The short version:
...
An honest assessment of what is and is not new lives in [`NOVELTY.md`](NOVELTY.md).
